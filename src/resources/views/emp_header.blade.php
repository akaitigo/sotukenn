			...
			<div id="sidebarWrap">
				...
				<nav id="mainnav">
					...
					<div class="panel">
						...
						<ul id="sns">
							<li><a href="#" target="_blank"><img src="/img_submit/iconTw.png" width="20" height="20" alt="twitter"></a></li>
							<li><a href="#" target="_blank"><img src="/img_submit/iconInsta.png" width="20" height="20" alt="Instagram"></a></li>
