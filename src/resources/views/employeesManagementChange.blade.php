    ...
    <tbody>
        <form method="post" action="{{route('employeesManegementUpdate')}}">
            ...
            <tr>
                ...
                <td><input type="text" class="box" name="newEmpName" placeholder="{{ $emp->name }}"></td>
                <td><input type="email" class="box" name="newEmpEmail" placeholder="{{$emp->email}}"></td>
                <td><input type="text" class="box" name="newEmpAge" placeholder="{{$emp->age}}"></td>
                <td><input type="text" class="box" name="newEmpWeight" placeholder="{{ $emp->weight }}"></td>
                ...
                <td><input type="text" class="box" name="newEmpPassword" placeholder="Password"></td>
