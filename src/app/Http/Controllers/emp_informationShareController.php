...
class emp_informationShareController extends Controller
{
    ...
    {
        $user = Auth::user();
        return view('emp_informationRegisterView', compact('user'));
    }
